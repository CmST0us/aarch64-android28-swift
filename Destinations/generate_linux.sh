...
json_content=$(cat <<EOF
{
    ...
    "sysroot-flag": "$ndk_path/toolchains/llvm/prebuilt/linux-x86_64/sysroot",
    "toolchain-bin-dir": "$swift_compiler_path",
    "target": "aarch64-unknown-linux-android28",
    "dynamic-library-extension": "so",
    "extra-cc-flags": [
        "-isystem", "$ndk_path/toolchains/llvm/prebuilt/linux-x86_64/lib/clang/17/include/",
        "-isystem", "$ndk_path/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/"
    ],
    "extra-swiftc-flags": [
        "-target", "aarch64-unknown-linux-android28",
